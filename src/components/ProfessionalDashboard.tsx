...
import { supabase, uploadFileToSupabase, fetchChatSessions, saveRegisteredProfessional, fetchUserJobApplications } from '../lib/supabase';
import { ChatSession, Professional, Rating, PortfolioItem, JobApplication } from '../types';
import { MessageSquare, Star, ArrowRight, Award, Phone, Mail, Edit3, CheckCircle, Clock, Plus, Trash2, ExternalLink, Image as ImageIcon, MapPin, Eye, KeyRound, Lock, Shield, Briefcase, CheckCircle2, Clock3, Sparkles, FileText } from 'lucide-react';
