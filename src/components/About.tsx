export function About() {
  return (
    <section id="about" className="py-16 sm:py-24 bg-white/60 border-y border-gray-200/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12 items-center">
          <div>
            <span className="text-indigo-600 font-semibold tracking-wider uppercase text-xs sm:text-sm mb-2 block">Our Story</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              About <span className="text-indigo-600">iDEA Creation Hub</span>
            </h2>
          ...
          <div className="relative">
            <div className="aspect-video md:aspect-video rounded-2xl overflow-hidden border border-gray-300 shadow-2xl">
              <img 
            ...
            <div className="absolute -bottom-6 -left-6 w-40 sm:w-48 h-40 sm:h-48 bg-indigo-600/10 rounded-full blur-2xl pointer-events-none" />
          </div>
        </div>
      </div>
    </section>
