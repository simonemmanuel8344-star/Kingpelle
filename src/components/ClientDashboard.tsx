...
import { 
  supabase, 
  fetchChatSessions, 
  fetchUserJobApplications, fetchUserNotifications, markNotificationAsRead, markAllNotificationsAsRead 
} from '../lib/supabase';
...
export function ClientDashboard({ onNavigateToJobs }: ClientDashboardProps) {
  ...
  const [activeTab, setActiveTab] = useState<'applications' | 'chats' | 'settings' | 'notifications' | 'escrow'>('applications');
